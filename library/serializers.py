...
#     class Meta:
#         model = Book
#         fields = ('id', 'title', 'publication_date', 'isbn', 'authors')
#         extra_kwargs = {
#             'title': {'required': True},
#             'isbn': {'required': True},
#         }
...
#     class Meta:
#         model = Book
#         fields = ('id', 'title', 'description', 'publication_date', 'isbn', 'authors')
#         depth = 1
# #optional class not mandatory can remove if causes error
